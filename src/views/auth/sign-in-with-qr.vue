<template>
    <AuthLayout>
        <div
            class="backdrop-blur-2xl bg-default-950/40 rounded-2xl overflow-hidden max-w-5xl mx-auto"
        >
            <div class="grid lg:grid-cols-2 gap-10">
                <div class="hidden lg:block ps-4 py-4">
                    <div
                        class="relative rounded-xl overflow-hidden h-full w-full"
                    >
                        <img
                            :src="authImg"
                            alt=""
                        ...
                        <div class="absolute inset-0 bg-default-950/40">
                            ...
                            >
                                <div class="text-center">
                                    <div
                                        class="bg-white/30 backdrop-blur-3xl rounded-md h-44 w-44 inline-flex items-center justify-center"
                                    >
                                        <img
                                            :src="qrCode"
                                    ...
                                    <h5
                                        class="text-xl font-bold text-white mb-3 mt-5"
                                    >
                                        Login with QR code.
                                    </h5>
                                    <p
                                    ...
                                    >
                                        Scan this with the mobile app to login
                                        instantly.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="flex flex-col h-full p-10 lg:ps-0">
                    ...
                    <div class="pb6 my-auto">
                        ...
                        <form action="#" class="text-start">
                            ...
                            <div class="mb-6">
                                <div
                                    class="flex flex-wrap items-center justify-between gap-y-1"
                                >
                                    <div>
                                        <input
                                            type="checkbox"
                    ...
                    <div>
                        <div class="text-center">
                            <p
                                class="text-lg text-default-200 font-semibold mb-4"
                            >
                                Sign in with
                            </p>
                            <ul
                            ...
                            >
                                <li>
                                    <a
                                        ...
                                        ><i
                                            class="mdi mdi-facebook text-2xl text-white group-hover:text-white"
                                        ></i
                                    ></a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        ><i
                                            class="mdi mdi-instagram text-2xl text-white group-hover:text-white"
                                        ></i
                                    ></a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        ><i
                                            class="mdi mdi-linkedin text-2xl text-white group-hover:text-white"
                                        ></i
                                    ></a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        ><i
                                            class="mdi mdi-github text-2xl text-white group-hover:text-white"
                                        ></i
                                    ></a>
                                </li>
                            </ul>

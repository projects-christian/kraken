              ...
              <div class="flex items-center justify-center h-full">
                <div class="text-center">
                  <div
                    ...
                    <img :src="qrCode" class="rounded-xl mx-auto h-40" alt="">
                  </div>
                  <h5 class="text-xl font-bold text-white mb-3 mt-5">Login with QR code.</h5>
                  <p class="text-base font-medium text-default-200">Scan this with the mobile app to login
                    instantly.</p>
                </div>
              </div>
            </div>
            ...
            <form action="#" class="text-start">
              ...
              <div class="mb-6 text-center">
                <button
                    ...
                    type="submit"><span class="fw-bold">Sing Up</span></button>
              </div>
            </form>
          </div>
          <div>

    ...
    <router-link :to="demo.route" class="w-full lg:w-1/2 p-3">
        ...
        >
            <div class="p-4">
                <div class="relative rounded-lg overflow-hidden">
                    ...
                    >
                        ...
                        >
                            Live Preview
                            <span
                                class="h-8 w-8 inline-flex items-center justify-center rounded-full bg-white border border-white text-primary ms-3"
                                ><i
                                    class="mdi mdi-share-all-outline text-lg"
                                ></i
                            ></span>
                        </div>
                    </div>
                ...
                <h5
                    class="mt-5 text-xl font-semibold text-white text-center capitalize"
                >
                    {{ demo.name }}
                </h5>
            </div>

<template>
    <div
        class="bg-default-950/40 backdrop-blur-3xl group rounded-lg space-y-6 overflow-hidden p-3"
        data-aos="fade-right"
                ...
                <div class="bg-black/60 h-full w-full rounded">
                    <div class="flex items-end h-full p-4">
                        <div>
                            ...
                            <h5 class="text-3xl font-bold text-white mb-4">
                                {{ blog.title }}
                            </h5>
                            <p
                                class="text-base font-semibold text-default-100 mb-6 whitespace-nowrap md:whitespace-normal truncate"
                            >
                                {{ blog.description }}
                            </p>
                            <a
                                href="#"
                                class="text-white border-b border-dashed border-default-200 pb-1"
                                >Read More

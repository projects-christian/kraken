<template>
    <section id="home" class="relative pt-[74px] overflow-hidden">
        <div class="container-fluid lg:px-10 md:px-3 relative overflow-hidden">
            <div
                class="lg:py-24 py-[74px] md:rounded-lg shadow bg-default-950/40 backdrop-blur-3xl"
            >
                    ...
                    Now <i class="mdi mdi-arrow-top-right-thin text-xl leading-[0]"></i></a>
                        ...
                        >
                            <div class="flex gap-4 md:gap-6 tilt">
                                <div
                                    class="flex flex-col gap-4 md:gap-6 pt-10 md:pt-16 w-full"
                                >
                                    <img
                                        :src="nftArt22"
                                ...
                                <div
                                    class="flex flex-col gap-4 md:gap-6 pb-10 md:pb-16 w-full relative"
                                >

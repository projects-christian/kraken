            ...
            <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div class="absolute inset-0">
                        <div class="h-full w-full">
                            <div class="flex items-end h-full w-full p-5">
                                <div
                                    class="bg-white/10 backdrop-blur-md p-6 rounded w-full"
                                >
                                    <h2
                                        class="text-lg font-normal text-center text-default-300"
                                    >
                                        Gaze upon the awe-inspiring creation of
                                        artificial intelligence, a majestic
                        ...
                        <div class="absolute inset-0">
                            <div class="h-full w-full">
                                <div class="flex items-end h-full w-full p-5">
                                    ...
                                    >
                                        <h3
                                            class="text-lg font-normal text-center text-default-200"
                                        >
                                            An enchanting ice dragon born from
                                ...
                                <div class="flex items-end h-full w-full p-5">
                                    ...
                                    >
                                        <h3
                                            class="text-lg font-normal text-center text-default-200"
                                        >
                                            A marvel of mechanical artistry and
                                            AI ingenuity
                                        </h3>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-end h-full w-full p-5">
                                ...
                                >
                                    <h3
                                        class="text-lg font-normal text-center text-default-200"
                                    >
                                        In the heart of an enchanted forest, an
                                        AI-born dragon stands as a guardian of
                                        the woods
                                    </h3>
                                </div>
                            </div>
                ...
                >
                    ...
                    <div class="absolute inset-0">
                        <div class="h-full w-full">
                            <div
                                class="flex items-end justify-end h-full w-full p-5"
                            >
                                <a
                                    href="#"

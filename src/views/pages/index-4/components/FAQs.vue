    ...
    <section id="faq" class="py-20">
        <div class="container">
            <div class="grid xl:grid-cols-2 gap-6">
                <div
                    class="xl:text-start text-center"
                    data-aos="fade-right"
                ...
                >
                    ...
                    <a
                        href="#"
                        class="mt-10 inline-flex items-center justify-center gap-2 border border-white/10 text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300"
                        >See More
                        ...
                        >
                            ...
                            >
                                <h5 class="text-base font-semibold flex">
                                    <HelpCircle
                                        class="h-5 w-5 stroke-white align-middle me-3"
                                    />
                                    {{ item.question }}
                                </h5>
                                <ChevronUp
                            ...
                            >
                                <div class="px-6 pb-4 pt-0">
                                    <p
                                        class="text-default-300 text-sm font-medium mb-2"
                                    >
                                        {{ item.answer }}
                                    </p>
                                </div>
...
import { faqs } from "@/views/pages/index-4/components/data";
import { ChevronUp, HelpCircle, MoveRight } from "lucide-vue-next";
</script>

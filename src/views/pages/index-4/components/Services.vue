                ...
                <div class="p-6">
                    <div>
                        ...
                        >
                            <button
                                type="button"
                                class="hs-tab-active:-semibold hs-tab-active:bg-primary py-5 px-10 rounded-lg items-center gap-2 border border-white/10 -mb-px transition-all text-lg font-medium space-nowrap text-white"
                            ...
                            <button
                                type="button"
                                class="hs-tab-active:-semibold hs-tab-active:bg-primary py-5 px-10 rounded-lg items-center gap-2 border border-white/10 -mb-px transition-all text-lg font-medium space-nowrap text-white active"
                            ...
                            >
                                <div class="grid xl:grid-cols-2 gap-6">
                                    ...
                                    >
                                        ...
                                        <p
                                            class="text-base font-medium text-default-200 mt-5"
                                        >
                                ...
                                <div class="grid xl:grid-cols-2 gap-6">
                                    ...
                                    >
                                        <h2
                                            class="text-3xl font-medium text-white"
                                        >
                                            Create eye-catching images and
                                            graphics.
                                        </h2>
                                        <p
                                            class="text-base font-medium text-default-200 mt-5"
                                        ...
                                        <p
                                            class="text-base font-medium text-default-200 mt-4"
                                        >
                                    ...
                                    >
                                        <div>
                                            <h2
                                                class="text-lg font-medium text-white mb-8"
                                            >
                                                Advanced options+
                                            </h2>
                                ...
                                <div class="grid xl:grid-cols-2 gap-6">
                                    ...
                                    >
                                        <h2
                                            class="text-3xl font-medium text-white"
                                        >
                                            Generate high quality code in no
                                            time.
                                        </h2>
                                        <p
                                            class="text-base font-medium text-default-200 mt-5"
                                    ...
                                    >
                                        <div
                                            class="bg-default-900/50 p-3 rounded-lg"
                                        >
                                            <h2
                                            ...
                                            <p
                                                class="text-base font-medium text-default-200 py-5"
                                            >
                                                "date pulbilshed":
                                            ...
                                            <P
                                                class="text-base font-medium text-default-200"
                                                >"author":{ <br />
                                                <span class="ps-7"
                                                    >"private":
                                                    <span class="text-primary"
                                            ...
                                            <P
                                                class="text-base font-medium text-default-200 pt-5"
                                                >"publlsher":{ <br />
                                                <span class="ps-7"
                                                    >"@type":
                                                    <span class="text-primary"

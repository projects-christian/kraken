    ...
    <div class="container">
      <div class="flex items-end justify-between mb-10">
        <div class="max-w-2xl mx-auto text-center">
          <h2 class="text-3xl font-medium capitalize text-white mb-4">What can it write for you?</h2>
...
import FeatureCard from "@/views/pages/index-4/components/FeatureCard.vue";
import {features} from "@/views/pages/index-4/components/data";
</script>
<template>
    <section
        id="home"
        class="relative overflow-hidden pt-[72px] pb-14"
        data-aos="zoom-out"
    ...
    >
        <div class="px-10">
            <div
                class="rounded-2xl overflow-hidden bg-no-repeat bg-cover"
                ...
                <div class="bg-default-950/70 rounded-2xl">
                    <div class="container">
                        <div class="p-6 relative">
                            <div
                                class="absolute top-20 start-80 -z-1 animate-[spin_10s_linear_infinite]"
                            >
                                <img :src="star" alt="" />
                            </div>
                            <div
                                class="absolute tot-auto bottom-40 end-60 -z-1 animate-[spin_10s_linear_infinite]"
                            >
                                <img :src="star" alt="" />
                            </div>
                            <div
                                class="absolute tot-auto bottom-96 end-36 -z-1 animate-[spin_10s_linear_infinite]"
                            >
                                <img :src="star" alt="" />
                            </div>

                            <div
                                class="flex h-full items-center justify-center py-36"
                            >
                                <div
                                    class="text-center max-w-3xl mx-auto relative"
                                >
                                    <span
                                        class="py-1 px-3 rounded-md text-sm font-medium uppercase tracking-wider text-white/80 bg-white/10"
                                        >AI knowledge hub</span
                                    >
                                    <h1
                                        class="md:text-5xl/snug text-3xl font-semibold text-white mt-10"
                                    >
                                        AI-Powered Solution For Effective
                                        Business.
                                    </h1>
                                    <p
                                        class="w-3/4 mx-auto text-base font-normal text-default-200 mt-5"
                                    >

<template>
    <div
        class="border p-6 border-white/10 rounded-xl bg-default-950/40 text-center"
        data-aos="fade-up"
        data-aos-easing="ease"
        data-aos-duration="1000"
    >
        <span
            class="inline-flex relative z-0 bg-primary/10 h-24 w-24 items-center justify-center"
        ...
        <p class="text-base font-medium text-default-200 mt-2 mb-6">
            {{ item.description }}
        </p>
        <a
            href="#"

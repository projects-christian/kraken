<template>
    <div
        class="border border-white/10 bg-default-950/40 overflow-hidden rounded-3xl p-10"
        data-aos="fade-up"
                ...
                <div class="flex flex-col">
                    <div class="relative">
                        <div class="opacity-100">
                            <div
                                class="group-hover:w-10 pb-12 group-hover:pb-8 transition-all duration-700"
                            >
                                <component
                                    :is="item.icon"
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                                <p
                                    class="text-base text-default-200 pb-5 flex items-center"
                                >
                                    Read more
                                    <ChevronRight

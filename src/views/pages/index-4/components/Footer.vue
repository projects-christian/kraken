    ...
    >
        <div class="container lg:px-20 py-20">
            ...
            <div class="flex flex-wrap items-center justify-center gap-5">
                <a
                    href="#"
                    class="text-lg font-medium text-default-400 hover:text-white transition-all duration-500"
                    >Management</a
                >
                <a
                    href="#"
            ...
            <div class="mt-6">
                <h6 class="text-lg font-semibold text-white text-center mb-4">
                    Follow US :
                </h6>
                <ul class="flex flex-wrap items-center justify-center gap-1">
                    <li v-for="(link, idx) in socialLinks" :key="idx">
                        <router-link
                            :to="link.route.url ? link.route.url : link.route"

<template>
    ...
    >
        <div
            class="absolute h-14 w-14 bg-primary/10 top-2/3 start-80 -z-1 rounded-2xl rounded-tl-none rounded-br-none animate-[spin_10s_linear_infinite]"
        ></div>
        <div
            class="absolute h-14 w-14 bg-primary/20 top-2/3 end-80 -z-1 rounded-full animate-ping"
        ></div>

        <div
            class="px-6 pt-20 overflow-hidden"
            data-aos="fade-up"
                ...
                <div class="container">
                    <div class="py-14 text-center relative">
                        <div class="flex justify-center">
                            <div class="max-w-2xl">
                                <h2
                                    class="md:text-6xl/tight text-5xl text-default-100 font-semibold mb-6"
                                >
                                    Make short videos From long ones instantly
                                </h2>
                                <p
                                    class="text-base text-default-200 font-medium px-5"
                                >
                                    At Video Podcast Creators, we're a
                                    collective of creative visionaries who
                                    believe in the art of visual storytelling.
                                    Our mission is to captivate, educate, and
                                ...
                                <p
                                    class="text-sm font-medium text-default-400 mt-5"
                                >

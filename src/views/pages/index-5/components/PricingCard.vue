<template>
    <div
        class="border rounded-lg border-white/10 bg-default-950/40 backdrop-blur-3xl"
    >
        <div class="p-6">
            <h1
                class="text-xl font-medium text-default-100 capitalize lg:text-2xl"
            >
                {{ plan.name }}
            </h1>
            ...
            <h2
                class="mt-4 text-2xl font-semibold text-default-200 sm:text-3xl"
            >
                {{ currency }}{{ plan.price
                }}<span class="text-base font-medium"
                    >/{{ toSentenceCase(duration) }}</span
                >
            </h2>

            <p class="mt-1 text-default-300">Pay every {{ duration }}</p>
        ...
        <div class="p-6">
            <h1 class="text-lg font-medium text-white capitalize lg:text-xl">
                What’s included:
            </h1>

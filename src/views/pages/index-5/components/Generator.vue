<template>
    ...
    >
        <div class="container">
            ...
            <div
                class="flex items-center flex-wrap rounded-3xl bg-default-950/40 backdrop-blur-3xl"
            >
                <div
                    class="md:w-1/2 w-auto grow md:border-e border-b border-white/10"
                >
                    <div class="sm:p-10 p-8">
                        <div
                            class="inline-flex items-center justify-center h-16 w-16 bg-primary/10 text-primary rounded-xl mb-10"
                        >
                        ...
                        <p class="text-base text-default-200 mb-6">
                            Customizing your post refers to the process of
                            tailoring your content to suit your specific goals,
                ...
                <div class="md:w-1/2 w-auto grow border-b border-white/10">
                    <div class="sm:p-10 p-8">
                        ...
                        <p class="text-base text-default-200 mb-6">
                            Instant content creation refers to the process of
                            generating high-quality written, visual, or
                            multimedia content quickly and efficiently.
                        </p>
                        <a
                            href="#"
                            class="inline-flex items-center justify-center gap-2 border border-white/10 text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300"
                ...
                <div
                    class="md:w-1/2 w-auto grow border-b md:border-b-0 md:border-e border-white/10"
                >
                    <div class="sm:p-10 p-8">
                        <div
                            class="inline-flex items-center justify-center h-16 w-16 bg-primary/10 text-primary rounded-xl mb-10"
                        ...
                        <p class="text-base text-default-200 mb-6">
                            AI-powered content suggestions leverage artificial
                            intelligence and machine learning algorithms to help
                            content creators generate ideas.
                        </p>
                        <a
                            href="#"
                            class="inline-flex items-center justify-center gap-2 border border-white/10 text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300"
                ...
                <div class="md:w-1/2 w-auto grow border-white/10">
                    <div class="sm:p-10 p-8">
                        ...
                        <p class="text-base text-default-200 mb-6">
                            ...
                            organizations to assist and address the needs,
                            concerns, and inquiries of their customers.
                        </p>
                        <a
                            href="#"
                            class="inline-flex items-center justify-center gap-2 border border-white/10 text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-300"

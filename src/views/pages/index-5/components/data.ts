...
export const features: FeatureType[] = [
    ...
    },
    {
        ...
        description:
            "Code Snippets: AI can generate code snippets in various programming languages.",
    },
    {
        icon: Palette,
        title: "Design and Visual Content",
        description:
            "Graphic Design: AI can generate images, logos, and other visual content.",
    },
    {
        icon: CaseSensitive,
        title: "Language Translation",
        description:
            "AI can translate text from one language to another and Ai can any language your choice.",
    },
];
